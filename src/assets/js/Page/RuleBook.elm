    ...
    div []
        ...
        , div [ class "content" ]
            ...
            , section [ id "reference" ]
                [ h1 [] [ dicText "rulebook.section.reference.title" "参考作品" ]
                , h2 [] [ dicText "rulebook.section.reference.trpg.title" "参考にしたTRPG" ]
                , ul []
                    [ li [] [ a [ href "http://incoglab.com/nechronica/" ] [ text "永い後日談のネクロニカ" ] ]
                    , li [] [ a [ href "https://lhrpg.com/" ] [ text "ログ･ホライズンＴＲＰＧ" ] ]
                    , li [] [ a [ href "https://lostrpg-751c1.firebaseapp.com/lost/" ] [ text "LOSTRPG ~ 廃墟の森の子供たち ~" ] ]
                    , li [] [ a [ href "http://www.fear.co.jp/dbx3rd/" ] [ text "ダブルクロス" ] ]
                    , li [] [ a [ href "http://www.fear.co.jp/gorder/" ] [ text "ガーデンオーダー" ] ]
                    ]
                , h2 [] [ dicText "rulebook.section.reference.game.title" "参考にしたゲーム" ]
                , ul []
                    [ li [] [ a [ href "https://cardwirth.net/" ] [ text "カードワース" ] ]
                    , li [] [ a [ href "https://www.questnotes.net/" ] [ text "クエストノーツ" ] ]
                    ]
                , h2 [] [ dicText "rulebook.section.reference.game.title" "参考漫画・アニメ" ]
                , ul []
                    [ li [] [ a [ href "https://ja.wikipedia.org/wiki/%E3%82%A2%E3%83%9B%E3%83%AA%E3%82%BA%E3%83%A0" ] [ text "アホリズム" ] ]
                    , li [] [ a [ href "https://ja.wikipedia.org/wiki/GUNSLINGER_GIRL" ] [ text "GUNSLINGER GIRL " ] ]
                    , li [] [ a [ href "https://ja.wikipedia.org/wiki/%E7%B5%B6%E5%AF%BE%E5%8F%AF%E6%86%90%E3%83%81%E3%83%AB%E3%83%89%E3%83%AC%E3%83%B3" ] [ text "絶対可憐チルドレン" ] ]
                    ]
                ]
            ]
        ]
